...
export class ConfimedeletetenantComponent implements OnInit {

  constructor(public dialog: MatDialog, private toastr: ToastrService, public dialogRef: MatDialogRef<ConfimedeletetenantComponent>, private errToastr: ErrorToastrService, private userService: UserService, @Inject(MAT_DIALOG_DATA) public data: User) { }
