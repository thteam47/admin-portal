...
@Component({
  selector: 'app-fake-category',
  templateUrl: './fake-category.component.html',
  styleUrls: ['./fake-category.component.css']
})
export class FakeCategoryComponent implements OnInit {

  selectRole = new FormControl('', Validators.required);
  form: FormGroup;
  constructor(private fb: FormBuilder, private errToastr: ErrorToastrService, private surveyService: SurveyService, private toastr: ToastrService, public dialogRef: MatDialogRef<FakeCategoryComponent>, @Inject(MAT_DIALOG_DATA) public data: User) {
