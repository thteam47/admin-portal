...
export class AddCategoryComponent implements OnInit {
  ...
  form: FormGroup;
  constructor(private fb: FormBuilder, private errToastr: ErrorToastrService, private userService: UserService, private toastr: ToastrService, public dialogRef: MatDialogRef<AddCategoryComponent>, @Inject(MAT_DIALOG_DATA) public data: User) {
