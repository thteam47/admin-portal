...
export class ConfimedeletecategoryComponent implements OnInit {

  constructor(public dialog: MatDialog, private toastr: ToastrService, public dialogRef: MatDialogRef<ConfimedeletecategoryComponent>, private errToastr: ErrorToastrService, private userService: UserService, @Inject(MAT_DIALOG_DATA) public data: User) { }
