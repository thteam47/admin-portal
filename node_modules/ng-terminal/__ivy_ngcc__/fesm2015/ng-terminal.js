...
NgTerminalService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: NgTerminalService, factory: NgTerminalService.ɵfac, providedIn: 'root' });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgTerminalService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
NgTerminalComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: NgTerminalComponent, selectors: [["ng-terminal"]], viewQuery: function NgTerminalComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, 7);
    } if (rf & 2) {
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.terminalDiv = _t.first);
    } }, inputs: { _dataSource: ["dataSource", "_dataSource"], _displayOption: ["displayOption", "_displayOption"], _style: ["style", "_style"] }, outputs: { keyInputEmitter: "keyInput", keyEventEmitter: "keyEvent" }, decls: 3, vars: 6, consts: [["mwlResizable", "", 1, "terminal-outer", 3, "ngStyle", "validateResize", "enableGhostResize", "resizeEdges", "resizeEnd"], ["terminal", ""]], template: function NgTerminalComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "global-style");
        ɵngcc0.ɵɵelementStart(1, "div", 0, 1);
        ɵngcc0.ɵɵlistener("resizeEnd", function NgTerminalComponent_Template_div_resizeEnd_1_listener($event) { return ctx.onResizeEnd($event.rectangle.left, $event.rectangle.top, $event.rectangle.width, $event.rectangle.height); });
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        ɵngcc0.ɵɵadvance(1);
    ...
    } }, directives: function () { return [GlobalStyleComponent, ɵngcc1.ResizableDirective, ɵngcc2.NgStyle]; }, styles: [".terminal-outer[_ngcontent-%COMP%]{box-sizing:border-box;height:100%}"] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgTerminalComponent, [{
        type: Component,
        args: [{
...
GlobalStyleComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: GlobalStyleComponent, selectors: [["global-style"]], decls: 0, vars: 0, template: function GlobalStyleComponent_Template(rf, ctx) { }, styles: [".xterm{position:relative;-moz-user-select:none;user-select:none;-ms-user-select:none;-webkit-user-select:none;cursor:text}.xterm.focus,.xterm:focus{outline:0}.xterm .xterm-helpers{position:absolute;top:0;z-index:5}.xterm .xterm-helper-textarea{padding:0;border:0;margin:0;position:absolute;opacity:0;left:-9999em;top:0;width:0;height:0;z-index:-5;white-space:nowrap;overflow:hidden;resize:none}.xterm .composition-view{background:#000;color:#fff;display:none;position:absolute;white-space:nowrap;z-index:1}.xterm .composition-view.active{display:block}.xterm .xterm-viewport{background-color:#000;overflow-y:scroll;cursor:default;position:absolute;right:0;left:0;top:0;bottom:0}.xterm .xterm-screen{position:relative}.xterm .xterm-screen canvas{position:absolute;left:0;top:0}.xterm .xterm-scroll-area{visibility:hidden}.xterm-char-measure-element{display:inline-block;visibility:hidden;position:absolute;top:0;left:-9999em;line-height:normal}.xterm.enable-mouse-events{cursor:default}.xterm.xterm-cursor-pointer{cursor:pointer}.xterm.column-select.focus{cursor:crosshair}.xterm .xterm-accessibility,.xterm .xterm-message{position:absolute;left:0;top:0;bottom:0;right:0;z-index:10;color:transparent}.xterm .live-region{position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden}.xterm-dim{opacity:.5}.xterm-underline{text-decoration:underline}.xterm-strikethrough{text-decoration:line-through}"], encapsulation: 2 });
/** @nocollapse */
GlobalStyleComponent.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(GlobalStyleComponent, [{
        type: Component,
        args: [{
...
NgTerminalModule.ɵfac = function NgTerminalModule_Factory(t) { return new (t || NgTerminalModule)(); };
NgTerminalModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: NgTerminalModule });
NgTerminalModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[
            ResizableModule, CommonModule
        ]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgTerminalModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgTerminalModule, { declarations: function () { return [NgTerminalComponent, GlobalStyleComponent]; }, imports: function () { return [ResizableModule, CommonModule]; }, exports: function () { return [NgTerminalComponent]; } }); })();
